...
- [CSharp-Backend](#csharp-backend)
  ...
  - [API Endpoints](#api-endpoints)
    ...
    - [Delete User by ID](#delete-user-by-id)
      - [API Full Documentation collection is available on Postman as well, awaiting publishing.](#api-full-documentation-collection-is-available-on-postman-as-well-awaiting-publishing)
